...
// «هجوم العمالقة» = ١٢ حرفاً ⇒ ٩ صفوف ⇒ «عادية» حسب قاعدة هالملف نفسه (٩ صفوف
// فأقل). ومع ذلك ما تسع بلا تمرير على ٣٦٠×٦٤٠ (أندرويد صغير). الباقي كله يعدّي.
//
// **مو انحدار**: تأكدنا إن نفس الفشل موجود على d58524b (قبل نافذة سجل التلميحات)،
// فهو قديم. معلّم هني عشان بقية الفحوص الـ٦٢ تظل حارسة بدل ما يصير الطقم أحمر
// دائماً فينتهي بتجاهله. لما ينصلح، يُشال هالتعليم ويرجع فحصاً عادياً.
const KNOWN_ISSUES = [["طولي صغير 360x640", "هجوم العمالقة"]];
const KNOWN_ISSUE_NOTE = "٩ صفوف على ٣٦٠×٦٤٠ ما تسع — عيب قديم، مو من تغيير جديد";
