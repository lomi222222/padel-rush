...
(function () {
  ...
  // بطاقة لكل فئة: رمز فوق واسم تحت. قيود تخلّي الاختبارات تشتغل بلا تعديل:
  // - الوسم يظل <label class="category-chip"> — اختبارات تشير له بالاسم
  // - الـinput يظل قابلاً للضغط (شفاف يغطّي البطاقة، مو hidden) — اختبارات
  //   تضغطه مباشرة، والمخفي ما ينضغط
  // - نص الـlabel = اسم الفئة **بالضبط**: الاسم بعنصر واحد، وعلامة الاختيار من
  //   CSS (::after) مو من عقدة نصية، وبلا مسافات زايدة. فحص يقارنه حرفياً
